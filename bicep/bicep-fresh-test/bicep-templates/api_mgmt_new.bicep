...
output apiPrivateIpAddress string = apiManagementService.properties.privateIPAddresses
...
resource privateDnsZonesARecordResource 'Microsoft.Network/privateDnsZones/A@2020-06-01' = [for arecord in apiARecords: {
  name: '${arecord}'
  parent: privateDnsZones
  properties: {
    aRecords: [
      {
        ipv4Address: apiManagementService.properties.privateIPAddresses
      }
    ]
    ttl: 3600
  }
