...
var aroAppUrl = 'apps.${domain}.${location}.aroapp.io'
...
param apiVnetType string

var apiARecords = [
  '${apiManagementServiceName}'
  '${apiManagementServiceName}.developer'
  '${apiManagementServiceName}.management'
  '${apiManagementServiceName}.portal'
  '${apiManagementServiceName}.scm'
]
...
var apiResources = [
  ...
  }
  {
    ...
    apiFormat: 'openapi+json'
    apiPath: 'Maximo-SIT'
    apiValue: '{"openapi":"3.0.1","info":{"title":"Maximo-SIT","contact":{},"version":"1.0"},"servers":[{"url":"https://10.231.8.24:18443/maximo/api/os"}],"paths":{"/*":{"get":{"summary":"Common-Get","description":"Generic get method to support all get calls to Maximo","operationId":"common-get","responses":{"200":{"description":null}}},"post":{"summary":"Common-Post","description":"Generic Post method to support all post calls to Maximo","operationId":"common-post","responses":{"200":{"description":null}}}}},"components":{"securitySchemes":{"apiKeyHeader":{"type":"apiKey","name":"Ocp-Apim-Subscription-Key","in":"header"},"apiKeyQuery":{"type":"apiKey","name":"subscription-key","in":"query"}}},"security":[{"apiKeyHeader":[]},{"apiKeyQuery":[]}],"tags":[{"name":"dev","description":""}]}'
    protocols: [
       'https'
    ]
    apiPolicyValue: '<!--\r\n    IMPORTANT:\r\n    - Policy elements can appear only within the <inbound>, <outbound>, <backend> section elements.\r\n    - To apply a policy to the incoming request (before it is forwarded to the backend service), place a corresponding policy element within the <inbound> section element.\r\n    - To apply a policy to the outgoing response (before it is sent back to the caller), place a corresponding policy element within the <outbound> section element.\r\n    - To add a policy, place the cursor at the desired insertion point and select a policy from the sidebar.\r\n    - To remove a policy, delete the corresponding policy statement from the policy document.\r\n    - Position the <base> element within a section element to inherit all policies from the corresponding section element in the enclosing scope.\r\n    - Remove the <base> element to prevent inheriting policies from the corresponding section element in the enclosing scope.\r\n    - Policies are applied in the order of their appearance, from the top down.\r\n    - Comments within policy elements are not supported and may disappear. Place your comments between policy elements or at a higher level scope.\r\n-->\r\n<policies>\r\n  <inbound>\r\n    <base />\r\n    <validate-jwt header-name="Authorization" failed-validation-httpcode="401" failed-validation-error-message="Unauthorized. Access token is missing or invalid.">\r\n      <openid-config url="https://login.microsoftonline.com/60beb100-3973-4346-bd68-d1c4eb6f4c42/.well-known/openid-configuration" />\r\n      <audiences>\r\n        <audience>https://mymipapi.water.ie</audience>\r\n      </audiences>\r\n    </validate-jwt>\r\n    <set-header name="Content-Type" exists-action="override">\r\n      <value>application/json</value>\r\n    </set-header>\r\n    <set-header name="x-public-uri" exists-action="override">\r\n      <value>http://maximo-project2.vip.iwater.ie/maximo/api</value>\r\n    </set-header>\r\n  </inbound>\r\n  <backend>\r\n    <base />\r\n  </backend>\r\n  <outbound>\r\n    <base />\r\n  </outbound>\r\n  <on-error>\r\n    <base />\r\n  </on-error>\r\n</policies>'
  ...
  {
    displayName: 'Maximo-UAT'
    apiType: 'http'
    apiRevision: '1'
    apiFormat: 'openapi+json'
    apiPath: 'Maximo-SIT'
    apiValue: '{"openapi":"3.0.1","info":{"title":"Maximo-SIT","contact":{},"version":"1.0"},"servers":[{"url":"https://10.231.8.24:28443/maximo/api/os"}],"paths":{"/*":{"get":{"summary":"Common-Get","description":"Generic get method to support all get calls to Maximo","operationId":"common-get","responses":{"200":{"description":null}}},"post":{"summary":"Common-Post","description":"Generic Post method to support all post calls to Maximo","operationId":"common-post","responses":{"200":{"description":null}}}}},"components":{"securitySchemes":{"apiKeyHeader":{"type":"apiKey","name":"Ocp-Apim-Subscription-Key","in":"header"},"apiKeyQuery":{"type":"apiKey","name":"subscription-key","in":"query"}}},"security":[{"apiKeyHeader":[]},{"apiKeyQuery":[]}],"tags":[{"name":"dev","description":""}]}'
    protocols: [
       'https'
    ]
    apiPolicyValue: '<!--\r\n    IMPORTANT:\r\n    - Policy elements can appear only within the <inbound>, <outbound>, <backend> section elements.\r\n    - To apply a policy to the incoming request (before it is forwarded to the backend service), place a corresponding policy element within the <inbound> section element.\r\n    - To apply a policy to the outgoing response (before it is sent back to the caller), place a corresponding policy element within the <outbound> section element.\r\n    - To add a policy, place the cursor at the desired insertion point and select a policy from the sidebar.\r\n    - To remove a policy, delete the corresponding policy statement from the policy document.\r\n    - Position the <base> element within a section element to inherit all policies from the corresponding section element in the enclosing scope.\r\n    - Remove the <base> element to prevent inheriting policies from the corresponding section element in the enclosing scope.\r\n    - Policies are applied in the order of their appearance, from the top down.\r\n    - Comments within policy elements are not supported and may disappear. Place your comments between policy elements or at a higher level scope.\r\n-->\r\n<policies>\r\n  <inbound>\r\n    <base />\r\n    <validate-jwt header-name="Authorization" failed-validation-httpcode="401" failed-validation-error-message="Unauthorized. Access token is missing or invalid.">\r\n      <openid-config url="https://login.microsoftonline.com/60beb100-3973-4346-bd68-d1c4eb6f4c42/.well-known/openid-configuration" />\r\n      <audiences>\r\n        <audience>https://mymipapi.water.ie</audience>\r\n      </audiences>\r\n    </validate-jwt>\r\n    <set-header name="Content-Type" exists-action="override">\r\n      <value>application/json</value>\r\n    </set-header>\r\n    <set-header name="x-public-uri" exists-action="override">\r\n      <value>http://maximo-project2.vip.iwater.ie/maximo/api</value>\r\n    </set-header>\r\n  </inbound>\r\n  <backend>\r\n    <base />\r\n  </backend>\r\n  <outbound>\r\n    <base />\r\n  </outbound>\r\n  <on-error>\r\n    <base />\r\n  </on-error>\r\n</policies>'
...
var storageAccountAzureFileName = '${prefix}${envmnt}AROFILE${instancenum}'
...
var allARecords = [
  {
    arecordName: 'vault-arecord-01'
    privateDnsZoneName: 'vault.azure.net'
    privateDnsZoneARecord: keyVaultName
    privateIpAddress: '10.86.30.133'
  }
  {
    arecordName: 'acr-arecord-01'
    privateDnsZoneName: 'azurecr.io'
    privateDnsZoneARecord: '${acrName}'
    privateIpAddress: '10.86.30.134'
  }
  {
    arecordName: 'acr-arecord-02'
    privateDnsZoneName: 'azurecr.io'
    privateDnsZoneARecord: '${acrName}.${location}.data'
    privateIpAddress: '10.86.30.135'
  }
]

var acrId = '/subscriptions/${subscription().subscriptionId}/resourceGroups/${RGSHARED}/providers/Microsoft.ContainerRegistry/registries/${acrName}'

var pvtEndpoints = [
  {
    privateEndpointName: '${keyVaultName}-pep'
    serviceId: keyVaultShared.id
    groupIds: 'vault'
  }
  {
    privateEndpointName: '${acrName}-pep'
    serviceId: acrId
    groupIds: 'registry'
  }
]

var logAnalyticsWorkspaceName = '${prefix}${project}${envmnt}LOG${instancenum}'
...
param laLogRetention int = 30
param laDailyQuota int = 20

var appInsightsName = '${prefix}${project}${envmnt}AIN${instancenum}'
param appInsightRetentionDays int = 30
...
module storageAccountAzureFileMod '../bicep-templates/storageAccount.bicep' = {
  name: 'storageAccountAzureFileName-Deploy'
...
module storageAccountAzureFileRAMod '../bicep-templates/roleAssignment.bicep' = {
  ...
  scope: resourceGroup(RGSTG)
  params:{
    raName: guid(resourceGroup().id, deployment().name, storageAccountAzureFileMod.outputs.storageAccountId)
...
module privateDnsZoneModule '../bicep-templates/privateDnsZone.bicep' = [for dnsZone in pvtDnsZones: {
  name: '${dnsZone}.deploy'
  params:{
...
module privateDnsZneARecordModule '../bicep-templates/privateDnsZoneARecord.bicep' = [for aRecord in allARecords: {
  name: '${aRecord.arecordName}-Deploy.ARecords'
  params:{
    privateDnsZoneName: aRecord.privateDnsZoneName
    privateDnsZoneARecord: aRecord.privateDnsZoneARecord
    privateIpAddress: aRecord.privateIpAddress
  }
}]

module privateEndpointsModule '../bicep-templates/privateEndpoint.bicep' = [ for ep in pvtEndpoints: {
  name: '${ep.privateEndpointName}.Deploy'
  params:{
    virtualNetworkName: vnetName
    pvtSubnetName: subnetPvt
    privateEndpointName: ep.privateEndpointName
    location: location
    tags: tags
...
module logAnalyticsWorkspaceModule '../bicep-templates/loganalyticsworkspace.bicep' = {
  ...
  params:{
    ...
    tags: tags
    skuName: laSkuName
    retentionDays: laLogRetention
    dailyQuotaGB: laDailyQuota
  }
}

module applicationInsightsModule '../bicep-templates/app-insight.bicep' = {
  name: '{appInsightsName}.Deploy'
  params:{
    appInsightsName: appInsightsName
    location: location
    tags: tags
    retentionDays: appInsightRetentionDays
